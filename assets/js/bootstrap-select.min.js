              ...
              if (C && t) {
                ...
                O.selectpicker.view.canHighlight[y] ||
                  ...
                  E &&
                    ...
                    E.firstChild && E.firstChild.classList.add("active")),
              ...
              if (
                ...
                (i = n.prevHiddenIndex),
                  ...
                  g &&
                    ...
                    (R++,
                    D.push(M(!1, q.DIVIDER, N + "div")),
                    L.push({ type: "divider", optID: N }));
              } else {
                if (f && !0 !== n.divider) {
                  ...
                  D.push(M(!1, q.DIVIDER)),
                    L.push({ type: "divider", originalIndex: e, data: n });
                else {
                  var y;
        ...
        liHeight: function (e) {
          if (e || (!1 !== this.options.size && !this.sizeInfo)) {
            ...
            var v,
              ...
              C = {
                vert:
                  z(S ? S.paddingTop : y.css("paddingTop")) +
                  z(S ? S.paddingBottom : y.css("paddingBottom")) +
                  z(S ? S.borderTopWidth : y.css("borderTopWidth")) +
                  z(S ? S.borderBottomWidth : y.css("borderBottomWidth")),
                horiz:
                  z(S ? S.paddingLeft : y.css("paddingLeft")) +
                  z(S ? S.paddingRight : y.css("paddingRight")) +
                  z(S ? S.borderLeftWidth : y.css("borderLeftWidth")) +
                  z(S ? S.borderRightWidth : y.css("borderRightWidth")),
              },
              O = {
                vert:
                  C.vert +
                  z(S ? S.marginTop : y.css("marginTop")) +
                  z(S ? S.marginBottom : y.css("marginBottom")) +
                  2,
                horiz:
                  C.horiz +
                  z(S ? S.marginLeft : y.css("marginLeft")) +
                  z(S ? S.marginRight : y.css("marginRight")) +
                  2,
              };
          ...
          var s,
            ...
            e = function (e) {
              var t = {},
                i =
                  l.options.display ||
                  (!!F.fn.dropdown.Constructor.Default &&
          ...
          i || (i = this.selectpicker.main.map.newIndex[e]),
            ...
            a ||
              (!r &&
                ...
                (o = this.selectpicker.main.elements[n]).classList.remove(
                  "active"
                ),
          ...
          t.data("spaceSelect", !1),
            ...
            this.$menuInner.on("click", "li a", function (e, t) {
              var i = F(this),
                ...
                n =
                  S.selectpicker.current.map.originalIndex[
                    i.parent().index() + s
                  ],
                o = E(S.$element[0]),
              ...
              if (
                (S.multiple &&
                  ...
                  e.stopPropagation(),
                e.preventDefault(),
                !S.isDisabled() && !i.parent().hasClass(q.DISABLED))
              ) {
                      ...
                      if (u && 1 == u) {
                        ...
                        I[2] &&
                          ...
                          u &&
                            ...
                            ($.append(F("<div>" + x + "</div>")),
                            (r = !1),
                            S.$element.trigger("maxReached" + L)),
                          f &&
                            v &&
                            ($.append(F("<div>" + k + "</div>")),
                            (r = !1),
                            S.$element.trigger("maxReachedGrp" + L)),
                          setTimeout(function () {
                            S.setSelected(n, !1);
                          }, 10),
                ...
                !S.multiple || (S.multiple && 1 === S.options.maxOptions)
                  ? S.$button.focus()
                  : S.options.liveSearch && S.$searchbox.focus(),
                  r &&
                    ((o != E(S.$element[0]) && S.multiple) ||
                      (l != S.$element.prop("selectedIndex") && !S.multiple)) &&
                    ((y = [n, c.prop("selected"), o]),
            ...
            this.$menu.on(
              ...
              function (e) {
                e.currentTarget == this &&
                  (e.preventDefault(),
                  e.stopPropagation(),
                  S.options.liveSearch && !F(e.target).hasClass("close")
                    ? S.$searchbox.focus()
                    : S.$button.focus());
              }
            ),
              ...
              if (
                ...
                for (var c = n.length; r < c; r++) {
                  ...
                  ("divider" !== a.type ||
                    ...
                    a.hasOwnProperty("originalIndex") &&
                      ((u.selectpicker.search.map.newIndex[a.originalIndex] =
                        t.length - 1),
        ...
        keydown: function (e) {
          ...
          if (
            ...
            void 0 ===
              ...
              (t = -1),
              -1 !== t &&
                ((s = a.selectpicker.current.elements[t + m]).classList.remove(
                  "active"
                ),
            ...
            for (var I = 0; I < a.selectpicker.current.data.length; I++) {
              ...
              $(x, b, "startsWith", !0) &&
                a.selectpicker.view.canHighlight[I] &&
                ((x.index = I), w.push(x.originalIndex));
            }
            if (w.length) {
              var k = 0;
              c.removeClass("active").find("a").removeClass("active"),
                ...
                0 < u - (n = a.selectpicker.current.data[g]).position
                  ? ((o = n.position - n.height), (d = !0))
                  : ((o = n.position - a.sizeInfo.menuInnerHeight),
                    (d = n.position > u + a.sizeInfo.menuInnerHeight)),
                (s = a.selectpicker.current.elements[g]).classList.add(
                  "active"
                ),
                s.firstChild && s.firstChild.classList.add("active"),
                (a.activeIndex = w[k]),
          ...
          i &&
            ((e.which === T && !a.selectpicker.keydown.keyHistory) ||
              e.which === O ||
              (e.which === D && a.options.selectOnTab)) &&
